...
CREATE TABLE Staff(StaffID INT, SFirstname VARCHAR(20), SLastName VARCHAR(20), SMobile VARCHAR(11),SHomePhone VARCHAR(11), SEmail VARCHAR(20), SAddress VARCHAR(200), PRIMARY KEY (StaffID));
